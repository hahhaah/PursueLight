...
/**
 * 创建时间: 2020/07/18 12:13 <br>
 * 作者: xuziwei <br>
 * 描述: 定位的Service类，用户在运动时此服务会在后台进行定位。
 * God bless my code!!
 */
public class LocationService extends Service {
  ...
  private void recordLocation(LatLng locationValue, String locationDetail) {
    if (mRecordService != null) {
      mRecordService.recordSport(locationValue, locationDetail);
    }
  }
