...
public class MotionUtils {
  ...
  public static List<TraceLocation> parseToTraceLocationList(List<AMapLocation> list){
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      location = parseTraceLocation(aMapLocation);
  ...
  public static List<LatLng> parseToLatLngList(List<AMapLocation> list) {
  ...
  public static AMapLocation parseToLocation(String latLonStr) {
  ...
  public static ArrayList<AMapLocation> parseLocations(String latLonStr) {
    ...
    String[] latLonStrs = latLonStr.split(";");
    for (String latLonStr1 : latLonStrs) {
      AMapLocation location = parseToLocation(latLonStr1);
      if (location != null) {
        locations.add(location);
      }
    }
   ...
   * @param distance 距离
   */
  public static double calculateCalorie(double weight, double distance) {
