...
public class CountTimerUtil {
   ...
   */
  private static <T extends TextView> void start(final T animationViewTv, final int repeatCount,final AnimationState animationState) {
